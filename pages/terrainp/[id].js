...
export default function Terrainp() {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:3004/terrain/OneTerrain/"+window.location.pathname.split("/")[2]) 
        .then(res => res.json())
        .then((data) => {
              ...
              <div className="container">
                <div className="d-block d-sm-flex justify-content-between">
                  ...
                  <h3>
                   ...
                   <a href="/res"> <span className="badge badge-primary p-3 font-weight-normal ts-shadow__sm">Reserve maintenant</span></a>
                  </h3>
